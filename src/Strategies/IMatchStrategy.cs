...
public interface IMatchStrategy
{
    ...
    IEnumerable<MatchResult> FindMatches(string line, string pattern, IDynamicOptions options, string fileName, int lineNumber);
    ...
    bool CanApply(IDynamicOptions options);
}
...
public interface IMatchStrategyFactory
{
    ...
    IMatchStrategy CreateStrategy(IDynamicOptions options);
