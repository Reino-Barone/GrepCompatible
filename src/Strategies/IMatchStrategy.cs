...
public interface IMatchStrategy
{
    ...
    IEnumerable<MatchResult> FindMatches(string line, string pattern, DynamicOptions options, string fileName, int lineNumber);
    ...
    bool CanApply(DynamicOptions options);
}
...
public interface IMatchStrategyFactory
{
    ...
    IMatchStrategy CreateStrategy(DynamicOptions options);
