...
{
    public bool CanApply(DynamicOptions options) => options.GetFlagValue(OptionNames.FixedStrings);
...
public class RegexMatchStrategy : IMatchStrategy
{
    ...
    public bool CanApply(DynamicOptions options) => 
...
{
    public bool CanApply(DynamicOptions options) => options.GetFlagValue(OptionNames.WholeWord);
